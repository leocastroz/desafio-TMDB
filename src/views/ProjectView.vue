<template>
  <div class="mx-auto rounded-xl px-10">
    <div
      class="grid items-center justify-center items-center bg-gray-800 my-8 px-3 rounded sm:flex sm:justify-between"
    >
      ...
      <div class="py-4 flex">
        ...
        <DayWeek
          :DayWeek="DayWeek"
          @update:DayWeek="DayWeek = $event"
          @fetchMoviesDayWeek="fetchMoviesDayWeek"
        />
      </div>
    </div>
    <ul class="flex flex-wrap gap-5 justify-center">
      <li
        ...
        :key="movie.id"
        class="bg-gray-800 rounded-xl text-white cursor-pointer hover:scale-105 transition-transform duration-300 hover:bg-blue-700"
      ...
      >
        <div class="w-36">
          ...
          <p class="my-2 w-full text-center mx-auto text-gray-500 text-[13px]">
